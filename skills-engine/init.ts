...
import { BACKUP_DIR, BASE_DIR, BASE_INCLUDES, STINGYCLAW_DIR } from './constants.js';
...
export function initStingyclawDir(): void {
  const projectRoot = process.cwd();
  const stingyclawDir = path.join(projectRoot, STINGYCLAW_DIR);
