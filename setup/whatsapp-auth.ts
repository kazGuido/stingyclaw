...
<html><head><title>Stingyclaw - WhatsApp Auth</title>
...
<script>
  var startKey = 'stingyclaw_qr_start';
...
<html><head><title>Stingyclaw - Connected!</title>
<style>
...
<script>localStorage.removeItem('stingyclaw_qr_start');</script>
</body></html>`;
